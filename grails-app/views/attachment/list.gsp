                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="attachment" title="${message(code: 'attachment.attachment.label', default: 'Attachment')}" />
                        
                            <th><g:message code="attachment.citizen.label" default="Citizen" /></th>
                    ...
                    <g:each in="${attachmentInstanceList}" status="i" var="attachmentInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: attachmentInstance, field: "attachment")}</td>
                        
                            <td>${fieldValue(bean: attachmentInstance, field: "citizen")}</td>
