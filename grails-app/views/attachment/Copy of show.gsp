                    ...
                    <tbody>
                        ...
                        <tr class="prop">
							...
							<td valign="top" class="value">								
								<g:link controller="image" action="getPdfFile" params='["id":"${attachmentInstance?.id}", "property": "attachment", "domain": "Attachment"]'>
		    						${fieldValue(bean: attachmentInstance, field: "name")}
		    					</g:link>
		    				</td>
