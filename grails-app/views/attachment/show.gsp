            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="attachment.attachment.label" default="Attachment" /></td>
                            
							<td><img src="${createLink(controller: 'image', action: 'renderImage', id: attachmentInstance.id, params:['property':'attachment', 'domain':'Attachment'])}"/></td>
							
						</tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="attachment.citizen.label" default="Citizen" /></td>
                            
                            <td valign="top" class="value"><g:link controller="citizen" action="show" id="${attachmentInstance?.citizen?.id}">${attachmentInstance?.citizen?.encodeAsHTML()}</g:link></td>
