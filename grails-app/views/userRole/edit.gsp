...
<%@ page import="com.hamburger.UserRole" %>
<html>
    <head>
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: userRoleInstance, field: 'role', 'errors')}">
                                    <g:select name="role.id" from="${com.hamburger.Role.list()}" optionKey="id" value="${userRoleInstance?.role?.id}"  />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: userRoleInstance, field: 'user', 'errors')}">
                                    <g:select name="user.id" from="${com.hamburger.User.list()}" optionKey="id" value="${userRoleInstance?.user?.id}"  />
                                </td>
                            </tr>
