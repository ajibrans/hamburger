            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        --%><tr class="prop">
                            <td valign="top" class="name"><g:message code="person.profile.label" default="Profile" /></td>
                            
                            <td valign="top" class="value"><g:link controller="citizen" action="show" id="${personInstance?.profile?.id}">${personInstance?.profile?.encodeAsHTML()}</g:link></td>
